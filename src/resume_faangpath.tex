...
Utrecht University \hfill \textit{Utrecht, NL}
 ...
 \textbf{Co-Founder \& Software Developer} \hfill Jan 2020 - Jan 2023\\
...
\item \textbf{NTP pool hack.} {\textit{Hacking Lab course @ TU Delft.} Demonstrated vulnerability in NTP Pool. Wrote script to serve arbitrary timestamps to clients requesting times from NTP servers (widely used cluster of time servers). Script can be found at \href{https://github.com/djeelun/malicious-ntpserver}{djeelun/malicious-ntpserver}.}
